...
```zsh
# マーケットプレイスの追加
claude plugin marketplace add fec-nagoya-org/conference-organizing-knowledge-skill

# プラグインのインストール
claude plugin install conference-organizing-knowledge-skill

# Skillの使用（Claude Code内）
/conference-organizing-knowledge-skill
```
